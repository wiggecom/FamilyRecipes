namespace FamilyRecipes.Models
{
    public class Category
    {
        ...
        public string CategoryImage { get; set; } = "default_image.svg";
        public string CategoryIcon { get; set; } = "default_icon.svg";
        ...
        public static List<Category> GetCategories() 
        {
            List<Category> categories = new List<Category>{
                ...
                new Category { MainCategory = "Pizza", SubCategory = "Topping" },
                new Category { MainCategory = "BBQ", SubCategory = "Meat" },
                new Category { MainCategory = "BBQ", SubCategory = "Vegetable" },
                new Category { MainCategory = "Stews and Soups", SubCategory = "Meat" },
                new Category { MainCategory = "Stews and Soups", SubCategory = "Fish" },
                new Category { MainCategory = "Stews and Soups", SubCategory = "Other" },
                ...
                new Category { MainCategory = "Vegetarian", SubCategory = "Fresh" },
                new Category { MainCategory = "Vegetarian", SubCategory = "Legume" },
                new Category { MainCategory = "Salad", SubCategory = "Creamy" },
                new Category { MainCategory = "Salad", SubCategory = "Fresh" },
                new Category { MainCategory = "Salad", SubCategory = "Warm" },
                new Category { MainCategory = "Sandwich", SubCategory = "Subs" },
                new Category { MainCategory = "Sandwich", SubCategory = "Warm" },
                ...
                new Category { MainCategory = "Dessert", SubCategory = "Toppings" },
                ...
                new Category { MainCategory = "Beverage (Alcoholic)", SubCategory = "Milkshake" },
                ...
                new Category { MainCategory = "Beverage (Alcoholic)", SubCategory = "Warm" },
                new Category { MainCategory = "Beverage (Alcoholic)", SubCategory = "Punch" },
